...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'manager', 'employee', 'customer-support'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Roles', path: '/roles', entity: 'role', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    {
    ...
    { name: 'User Roles', path: '/user-roles', entity: 'user_role', service: AccessServiceEnum.PROJECT, icon: FiUsers },
