  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Biitbot - Your comprehensive chat hub for seamless company management. Harness the power of connectivity with integrated WhatsApp Business and Instagram DM, ensuring every message is seen and responded to."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1552664730-d307ca884978?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMGNvbW11bmljYXRpb258ZW58MHx8fHwxNjk1MzI4NjQ3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@jasongoodman_youxventures?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Jason Goodman`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Biitbot - Your comprehensive chat hub for seamless company management. Harness the power of connectivity with integrated WhatsApp Business and Instagram DM, ensuring every message is seen and responded to.`}
            </Text>
            <Box
