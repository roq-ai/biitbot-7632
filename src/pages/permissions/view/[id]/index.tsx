...
import { getPermissionById } from 'apiSdk/permissions';
import { PermissionInterface } from 'interfaces/permission';
import { RolePermissionListPage } from 'pages/role-permissions';

function PermissionViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('permission', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/permissions/edit/${id}`} passHref legacyBehavior>
                    <Button
