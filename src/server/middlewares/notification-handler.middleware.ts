...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #123 has been placed by a customer.create': {
    roles: ['owner', 'administrator', 'manager', 'customer-support'],
    key: 'order_create',
    tenantPath: [],
    userPath: [],
  },
  'Support ticket #456 has been opened by a customer.create': {
    roles: ['owner', 'administrator', 'manager', 'customer-support'],
    key: 'support_ticket_create',
    tenantPath: [],
    userPath: [],
  },
  'Inventory for product XYZ is low.update': {
...
const tenantRoles: string[] = ['owner', 'administrator', 'manager', 'employee', 'customer-support'];
